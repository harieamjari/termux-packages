...
#
	rm $TERMUX_PKG_SRCDIR/include/asm-generic/signal.h \
		$TERMUX_PKG_SRCDIR/include/uapi/asm-generic/signal-defs.h \
		$TERMUX_PKG_SRCDIR/include/uapi/asm-generic/signal.h
