...
TERMUX_PKG_SRCURL=https://android.googlesource.com/kernel/mediatek/+archive/android-mtk-${TERMUX_PKG_VERSION}.tar.gz
...
#	_PERF_EXTRA_CFLAGS+=" -I${TERMUX_PREFIX}/include"
	...
	sed -i -e 's/ -Werror//g' \
		$TERMUX_PKG_SRCDIR/tools/perf/config/feature-checks/Makefile
